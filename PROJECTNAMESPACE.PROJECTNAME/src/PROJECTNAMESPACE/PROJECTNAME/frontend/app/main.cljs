(ns ^:figwheel-hooks PROJECTNAMESPACE.PROJECTNAME.frontend.app.main
  (:require [day8.re-frame.http-fx]
            ...
            PROJECTNAMESPACE.PROJECTNAME.frontend.app.events
            PROJECTNAMESPACE.PROJECTNAME.frontend.app.subscriptions
            PROJECTNAMESPACE.PROJECTNAME.frontend.http
            [PROJECTNAMESPACE.PROJECTNAME.frontend.navigation :as nav]
            [PROJECTNAMESPACE.PROJECTNAME.frontend.app.views :as views]))
